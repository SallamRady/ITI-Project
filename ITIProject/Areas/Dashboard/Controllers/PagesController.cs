...
namespace ITIProject.Areas.Dashboard.Controllers
{
    ...
    public class PagesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Title,SubTitle,Content")] Page page)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Title,SubTitle,Content")] Page page)
        {
            if (ModelState.IsValid)
            {
